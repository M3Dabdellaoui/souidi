...
?>
            ...
            <div class="carousel-inner">
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                            <li class="nav-item">
                                <a href="index.html" class="nav-item nav-link active" style="font-size: 1.25rem">إستقبال</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-lg-9 pt-5 pt-lg-0">
                    ...
                    <div class="owl-carousel service-carousel position-relative" style="margin-top: -100px; padding: 0 30px;">
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4" >
                            ...
                            <h5 class="mb-4 px-4">من النصيحة <br >إلى<br > التقاضي</h5>
                            ...
                            <label for="check2" class="btn btn-primary mt-2">اقرأ أكثر</label>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4" >
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <label for="check3" class="btn btn-primary mt-2">اقرأ أكثر</label>
                        ...
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4" id="modif3">
                            ...
                            <h5 class="mb-4 px-4">طرق بديلة لحل النزاعات</h5>
                            ...
                            <label for="check4" class="btn btn-primary mt-2">اقرأ أكثر</label>
                        </div>
                        <!--another seervice-->
                        <!-- <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <h5 class="mb-4 px-4">مستشار قانوني </h5>
                            ...
                            <label for="check5" class="btn btn-primary mt-2">اقرأ أكثر</label>
                        </div> -->
                    </div>
                </div>

                <div class="col-lg-3" style="direction: rtl !important;">
                    <h6 class="text-uppercase">خدماتنا</h6>
    ...
    <div class="container-fluid py-5" id="team">
        <div class="container py-5">
            <div class="text-center pb-2">
                <h6 class="text-uppercase">فريقنا</h6>
    ...
    <div class="container-fluid py-5" id="team">
        <div class="container py-5">
            <div class="text-center pb-2">
                <h6 class="text-uppercase">شركاؤنا</h6>
