<?php
  include('db.php');
   ...
   $sql = "SELECT email FROM potential_clients";
...
<div class="container">
  <main>
    ...
    <div class="row g-5">
      ...
      <!-- UPLOAD LINK start -->
      <div class="col-md-7 col-lg-8" style="font-size: 18px;">
        <h1><img src="../img/email_title.png" alt="twbs" height="160" class="flex-shrink-0"> Clients Potentiel</h1><br />
        <p>Télecharger la liste des <b style="color : #b49c73;">clients potentiel</b>, envoyez-leur vos dernières nouvelles, tenez-les au courant.</p>
        ...
        <table class="table">
            ...
            <tbody>
              <tr>
                <td><img src='../img/excel.png' alt='Download' width='32' height='32'> potential_clients.csv</td>
