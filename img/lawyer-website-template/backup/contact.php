...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="about.html" class="nav-item nav-link">Notre Bureau</a>
                            <a href="service.html" class="nav-item nav-link">Nos Services</a>
                            <a href="team.html" class="nav-item nav-link">Nos Experts</a>
                            <!--Dropdown Menu-->
                            <!--<div class="nav-item dropdown">
    ...
    <!-- Contact Start -->
        <?php
           ...
           $destination="office@mail.com";
           $subject=$_POST["subject"];
           $message=
           "nom complet     : ".$_POST["name"]."<br />
           message          :".$_POST["message"]."<br/>";

           $headers="From: ".$_POST["email"];
           $headers.="Cc:  office@mail.com";
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate" method="POST" >
                            <div class="form-row">
                                <div class="col-sm-6 control-group">
                                    <input name="fname" type="text" class="form-control p-4" id="name" placeholder="Nom Complet" required="required" data-validation-required-message="S'il vous plaît entrez votre nom" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="col-sm-6 control-group">
                                    <input name="email" type="email" class="form-control p-4" id="email" placeholder="Votre Adresse Email" required="required" data-validation-required-message="Veuillez saisir votre e-mail" />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="control-group">
                                <input name="subject" type="text" class="form-control p-4" id="subject" placeholder="Sujet" required="required" data-validation-required-message="Veuillez entrer un sujet" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <textarea name="message" class="form-control p-4" rows="6" id="message" placeholder="Message" required="required" data-validation-required-message="Veuillez entrer votre message"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
                                <button class="btn btn-primary btn-block" type="submit" id="sendMessageButton">Envoyer un message</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-secondary text-white pt-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-semi-bold text-primary mb-4">Liens populaires</h4>
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Accueil</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Notre Bureau</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Nos Services</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Nos Experts</a>
                    <a class="text-white" href="#"><i class="fa fa-angle-right mr-2"></i>Contact</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-semi-bold text-primary mb-4">Liens rapides</h4>
                <div class="d-flex flex-column justify-content-start">
