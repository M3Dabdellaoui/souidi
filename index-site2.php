            ...
            <div class="carousel-inner">
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                            <li class="nav-item">
                                <a href="index-site2.php" class="nav-item nav-link active" style="font-size: 1.25rem" >Accueil</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="d-lg-flex col-lg-3 justify-content-lg-end">
                                <div class="d-inline-flex align-items-center p-2">
                                                ...
                                                <a class="btn btn-sm " href="index_Ar-site2.php" style="color : white;">
                ...
                <div class="carousel-item position-relative " style="height: 100vh; min-height: 400px;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-uppercase mb-4" style=" color :#B49C73; etter-spacing: 3px;"><i>Bureau d'arbitrage, de médiation, de redaction de contrats et actes juridiques &  contentieux</i></h3>
    ...
    <div class="container-fluid py-5" id="services">
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pt-lg-0" style="width: 400px;">
                    <div class="bg-primary rounded" style="height: 150px; width: 400px;"></div>
                    <div class="owl-carousel service-carousel position-relative" style="margin-top: -100px; padding: 0 30px; ">
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4" id="modif3" style="width: 340px;">
                            ...
                            <button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#service3">encore plus</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" tabindex="-1" id="service3"  aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <h6 class="modal-title text-center" style="font-size:1.5rem;">Modes Alternatifs de règlement des conflits</h6>
                <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                    <i class="fa fa-2x fa-handshake"></i>
                </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-4">
                <div class="justify-content-lg-cent p-4">
                    ...
                    <a href="index-site2.php" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-lg-cent">
